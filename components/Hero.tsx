...
const Hero: React.FC = () => {
  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      {/* Linear Gradient Overlay (Dark Green to Transparent) */}
        ...
        <div className="animate-fade-in-up" style={{ animationDelay: '0.2s' }}>
          ...
          <div className="flex flex-wrap justify-center gap-6">
            ...
            <a 
              ...
              className="flex items-center gap-3 px-8 py-4 bg-[#25D366] text-white font-serif-display font-bold rounded-lg shadow-xl hover:bg-[#1ebd5a] transition-all duration-300 transform hover:-translate-y-1"
            >
            ...
            <button 
              ...
              className="group flex items-center gap-3 px-8 py-4 bg-[#daa520] text-[#064e3b] font-serif-display font-bold rounded-lg shadow-xl gold-glow hover:bg-[#b8860b] transition-all duration-300 transform hover:-translate-y-1 relative z-30"
            >
